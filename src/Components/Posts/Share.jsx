    ...
    return (
        <Card sx={{ mb: 2, px: 2 }}>
            <Box sx={{ borderBottom: '1px solid #ddd', display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', py: 1 }}>
                <Avatar sx={{ mr: 1 }} alt="Ajinkya Bengal" src="/assets/images/users/Ajinkya2.jpg" />
                <ListItemText onClick={handleOpen} sx={{ cursor: 'pointer', backgroundColor: '#f0f2f5', py: 1, px: 2, borderRadius: '25px' }} primary="What's on your mind, Ajinkya?" />
            </Box>
                ...
                <Box sx={style}>
                    ...
                    <Box sx={{ p: 2 }}>
                        <Box >
                            <TextareaAutosize
                                maxRows={10}
                                placeholder="What's on your mind, Ajinkya?"
